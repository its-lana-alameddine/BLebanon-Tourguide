...
<body>
    ...
    <div class="containerform">
        <div class="login-form-container">
            <div class="forms">
                ...
                <form action="includes/login-inc-n.php" method="post" class="input-group-login">
                    <h3>Log In</h3>
    ...
    <div class="containerform">
        <div class="register-form-container">
            <form action="includes/register-inc-n.php" method="post" class="input-group-register" onkeyup="verifyPassword()" onsubmit="return verifyPassword()">
